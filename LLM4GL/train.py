...
from processor_esl_yhx import ESL_processor
...
def cross_validation(args, model_class, tokenizer, processor):  #processor是ESL_processor的一个类
    splits = KFold(n_splits=args.k_fold, shuffle=True, random_state=args.seed)
    logger.info("train dataloader generation")
    _, train_test_features, train_test_dataset = processor.generate_dataloader('train')  #只用了最后的数据
...
def main():
    ...
    parser.add_argument("--cache_path", default='/home/bojie.ma/DATACENTER3/yhx_ERGO/data/cached_eci_evening', type=str)
    parser.add_argument("--model_type", default='longformer', type=str)
    parser.add_argument("--output_dir", default='/home/bojie.ma/DATACENTER3/yhx_ERGO/outputs_res_yhx_evening', type=str)
    parser.add_argument("--model_name_or_path", default="/home/bojie.ma/DATACENTER3/project/ERGO-main/ckpts/longerformer-base-4096", type=str)
